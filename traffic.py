...
def load_data(data_dir):
    ...
    for sub_dir_number in range(NUM_CATEGORIES):
        
        image_dir = os.path.join(data_dir, str(sub_dir_number))
...
def get_model():
    ...
    model= tf.keras.Sequential([
        ...
        # Hidden layer with 128 functions
        tf.keras.layers.Dense(128, activation = tf.nn.relu), 
        
        # Output layer for the different types of traffic signs
